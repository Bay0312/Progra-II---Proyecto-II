...
//Metodos Varios
void Fuente::agregar() { throw new std::string("No se supone que la clase fuente agregue nada."); } //La clase que agrega es el composite, por lo que aqui se lanza una excepcion.
